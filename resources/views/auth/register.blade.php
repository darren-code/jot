                    ...
                    <form method="POST" action="{{ route('register') }}" class="pt-8">
                        ...
                        <div class="relative">
                            ...
                            {{-- <div class="col-md-6">
                                ...
                                @error('name')
                                    <span class="invalid-feedback text-red-600 text-sm pt-1" role="alert">
                        ...
                        <div class="relative pt-3">
                            ...
                            {{-- <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" class="Password"> --}}
                                <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" autocomplete="new-password" class="Password" placeholder="Password">
